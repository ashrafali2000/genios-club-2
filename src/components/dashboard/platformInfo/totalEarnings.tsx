...
const TotalEarnings = () => {
  ...
  const TotalEarnings =
    UseFormatEtherNumber(Platform?.G3X2TotalEarnings) +
    UseFormatEtherNumber(Platform?.G3X7TotalEarnings);

  const G3X2TotalEarnings = UseFormatEther(Platform?.G3X2TotalEarnings);
  const G3X7TotalEarnings = UseFormatEther(Platform?.G3X7TotalEarnings);
