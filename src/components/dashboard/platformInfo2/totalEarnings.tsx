...
const TotalEarnings = () => {
  ...
  const TotalEarnings = UseFormatEtherNumber(Users && Users[3]);
  console.log("Users ernings----->", TotalEarnings);

  //  +
  // UseFormatEtherNumber(Users?.G3X7TotalEarnings);

  const G3X2TotalEarnings = UseFormatEther(Users && Users[5]);
  // const G3X7TotalEarnings = UseFormatEther(Users?.G3X7TotalEarnings);
  ...
  return (
    <>
      ...
      <div className="mt-5 flex flex-col items-center  text-center">
        <h1 className="text-[18px] font-semibold text-white">
          PARTICIPANTS <br></br>HAVE EARNED DAI
        </h1>
